...
public class InduceBigramFeaturesVectors {
	static int Feature_Start = 48;
	...
	static ArrayList<String> getBigrams(ArrayList<String> unigrams){
		ArrayList<String> bigrams = new ArrayList<String>(unigrams);
		for(int i=0; i+1 < unigrams.size(); i++)
	...
	public void buildFeatures(String path){
		try{
			...
			while((line = br.readLine())!=null){
				...
				ArrayList<String> tokens = getBigrams(ParseDocument.parseDoc(class_and_doc[1]));// getBigrams(parseSimple(class_and_doc[1]));
